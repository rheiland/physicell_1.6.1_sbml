...
PhysiCell_custom_module_OBJECTS := ftest.o
...
#	$(COMPILE_COMMAND) -o $(PROGRAM_NAME) $(ALL_OBJECTS) main.cpp 
	$(COMPILE_COMMAND) -L${LIBRR_LIBS} -lroadrunner_c_api -o $(PROGRAM_NAME) $(ALL_OBJECTS) main_ftest.cpp
#	$(COMPILE_COMMAND) ${LIBRR_STUFF}  -o $(PROGRAM_NAME) $(ALL_OBJECTS) main_ftest.cpp
...
ftest.o: ./custom_modules/ftest.cpp 
	$(COMPILE_COMMAND) -c ./custom_modules/ftest.cpp
